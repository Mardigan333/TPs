...
if(contienePalabra(noticiaActual, palabra)){
    cambiarColor(noticiaActual, 'rgb(142, 224, 193)');
    }
  }
}
function resaltarNoticiasQueContenganArgentina(palabra){
for(var contador = 0; contador<noticias.length; contador++){
    noticiaActual = noticias[contador];
if(contienePalabra(noticiaActual, palabra)){
    cambiarColor(noticiaActual, 'rgb(160, 224, 199)');
    }
  }
}
...
recortarNoticias(20);
resaltarNoticiasQueContenganArgentina("ARGENTINA");
